// Путь: app/src/main/java/com/translator/app/learn/core/LearnCoreViewModel.kt
...
import com.translator.app.learn.domain.VocabularyViolation
...
class LearnCoreViewModel @Inject constructor(
    ...
    private val vocabularyEnforcer: com.translator.app.learn.domain.VocabularyEnforcer,
    private val translatorSession: com.translator.app.learn.sessions.translator.TranslatorSession,
    private val translationClient: com.translator.app.data.translator.GeminiTranslationClient,
) : ViewModel() {
    ...
    private fun openNewPair(): Long {
        ...
        _state.update { st -> st.copy(translatorPairs = st.translatorPairs + com.translator.app.learn.core.TranslationPair(id = id)) }
        return id
    }
    ...
    private fun updatePair(id: Long, transform: (com.translator.app.learn.core.TranslationPair) -> com.translator.app.learn.core.TranslationPair) {
        _state.update { st ->
    ...
    private fun safeStartForegroundService(): Boolean {
        return try {
            appContext.startForegroundService(
                com.translator.app.GeminiLiveForegroundService.startIntent(
    ...
    private fun safeStopForegroundService() {
        try {
            appContext.startService(
                com.translator.app.GeminiLiveForegroundService.stopIntent(appContext)
            )
        } catch (_: Exception) { }
    }
