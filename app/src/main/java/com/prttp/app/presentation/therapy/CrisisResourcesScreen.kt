...
object CrisisResources {
    ...
    fun forLocale(): List<CrisisResource> = listOf(
        CrisisResource(
            ...
            subtitle = "Если есть угроза жизни — звони немедленно.",
            phone = "112"
        ),
        CrisisResource(
            title = "Кризисная линия психологической помощи",
            subtitle = "Бесплатно, анонимно, круглосуточно — живой специалист.",
            phone = "<ВПИШИ_НОМЕР_РЕГИОНА>"
        ),
        CrisisResource(
            title = "Близкий человек",
            subtitle = "Позвони тому, кому доверяешь. Не оставайся один.",
            phone = null
        )
    )
}
